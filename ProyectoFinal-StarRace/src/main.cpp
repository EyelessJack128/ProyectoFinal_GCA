...
void applicationLoop() {
	...
	modelMatrixTIEFighter = glm::translate(modelMatrixTIEFighter, glm::vec3(7.0, 0.0, -40.0));

	modelMatrixTIEBomber = glm::translate(modelMatrixTIEBomber, glm::vec3(8.0, 0.0, -40.0));

	modelMatrixTIEInterceptor = glm::translate(modelMatrixTIEInterceptor, glm::vec3(9.0, 0.0, -40.0));
